    ...
    <div className="flex flex-column align-items-center justify-content-center h-screen p-4 overflow-hidden">
      <div className="surface-card p-4 shadow-2 border-round w-full lg:w-6 h-full overflow-y-auto">
        ...
        <div className="text-900 mb-4">
          ...
          <p className="mb-3">
            En este documento, &quot;Playgrounds&quot; se refiere a la
            plataforma web y móvil que permite a los usuarios organizar y
            participar en eventos deportivos, así como gestionar espacios
            deportivos. &quot;Usuario&quot; se refiere a cualquier persona que
            acceda o utilice la plataforma.
          </p>
          ...
          <p className="mb-3">
            ...
            participar en eventos deportivos. Nuestro objetivo es promover el
            deporte social y al aire libre, facilitando el encuentro de
            compañeros/as de deporte.
          </p>
          ...
          <p className="mb-3">
            ...
            actividades que ocurran bajo su cuenta. Playgrounds se reserva el
            derecho de suspender o cancelar cuentas que incumplan estos
            términos.
          </p>

          <h6 className="text-xl font-bold mb-2">5. Pagos y Facturación</h6>
          <p className="mb-3">
            No existen pagos o facturas en la plataforma. Playgrounds no
            pretende solicitar pagos de sus usuarios.
          </p>

          <h6 className="text-xl font-bold mb-2">6. Borrado de datos</h6>
          <p className="mb-3">
            Los usuarios pueden solicitar el borrado de todos sus datos
            contactando a soporte de playgrounds.
          </p>

          <h6 className="text-xl font-bold mb-2">7. Conducta del Usuario</h6>
          <p className="mb-3">
            Los usuarios deben comportarse de manera respetuosa. No se tolerará
            ningún tipo de acoso, discriminación o comportamiento inapropiado.
            Playgrounds se reserva el derecho de suspender o eliminar cuentas
            que violen estas normas de conducta.
          </p>

          <h6 className="text-xl font-bold mb-2">8. Privacidad</h6>
          <p className="mb-3">
            La información personal que recopilamos está sujeta a nuestra
            Política de Privacidad. Los datos del usuario solamente serán usados
            de forma interna sin el objetivo de lucrar de ellos ni ser
            compartidos.
          </p>
          ...
          <p className="mb-3">
            Playgrounds no será responsable por daños directos, indirectos,
            incidentales, especiales o consecuentes que resulten del uso o la
            imposibilidad de uso de la plataforma, incluyendo pero no limitado a
            la pérdida de datos, ingresos o reputación. Playgrounds no será
            responsable de daños o acciedentes sucedidos durante un evento
            coordinado por la plataforma. Dado que la misma solo es espacio para
            encontrar usuarios que deseen realizad deportes y no un organizador
            de eventos.
          </p>
          ...
          <p className="mb-3">
            ...
            de su publicación en la plataforma. Es responsabilidad del usuario
            revisar periódicamente los términos.
          </p>
          ...
          <p className="mb-3">
            ...
            Argentina. Cualquier disputa derivada del uso de Playgrounds será
          ...
          <p className="mb-3">
            ...
            playgrounds.contact@gmail.com o mediante el formulario de contacto
            en la plataforma.
          </p>
        </div>
